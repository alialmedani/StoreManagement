...
[DependsOn(
    ...
    typeof(StoreManagementWebModule),
    typeof(StoreManagementApplicationTestModule),
...
public class StoreManagementWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(StoreManagementWebModule).Assembly));
        });
