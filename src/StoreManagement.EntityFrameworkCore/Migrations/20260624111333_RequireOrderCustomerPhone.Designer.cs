...
namespace StoreManagement.Migrations
{
    ...
    [Migration("20260624111333_RequireOrderCustomerPhone")]
    partial class RequireOrderCustomerPhone
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreManagement.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("StoreManagement.Inventory.StockMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoreManagement.Media.Media", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BlobName")
                        .IsUnique()
                        .HasDatabaseName("UX_StoreManagement_Media_BlobName_Active")
                        .HasFilter("[IsDeleted] = 0");

                    b.HasIndex("CreationTime")
                        .HasDatabaseName("IX_StoreManagement_Media_CreationTime");

                    b.HasIndex("FileName")
                        .HasDatabaseName("IX_StoreManagement_Media_FileName");

                    b.HasIndex("EntityType", "EntityId")
                        .HasDatabaseName("IX_StoreManagement_Media_EntityType_EntityId");

                    b.ToTable("AppMedia", (string)null);
                });

            modelBuilder.Entity("StoreManagement.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CancellationTime")
                        .HasDatabaseName("IX_StoreManagement_Orders_CancellationTime");
                    ...
                    b.HasIndex("PaymentStatus")
                        .HasDatabaseName("IX_StoreManagement_Orders_PaymentStatus");
            ...
            modelBuilder.Entity("StoreManagement.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoreManagement.Orders.OrderNumberSequence", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppOrderNumberSequences", (string)null);
                });

            modelBuilder.Entity("StoreManagement.Orders.OrderPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CreationTime")
                        .HasDatabaseName("IX_StoreManagement_OrderPayments_CreationTime");

                    b.HasIndex("PaymentMethod")
                        .HasDatabaseName("IX_StoreManagement_OrderPayments_PaymentMethod");

                    b.HasIndex("OrderId", "PaymentDate")
                        .HasDatabaseName("IX_StoreManagement_OrderPayments_OrderId_PaymentDate");

                    b.ToTable("AppOrderPayments", (string)null);
                });

            modelBuilder.Entity("StoreManagement.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StoreManagement.Products.ProductVariant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("NormalizedSize")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.HasIndex("ProductId", "NormalizedColor", "NormalizedSize")
                        .IsUnique()
            ...
            modelBuilder.Entity("StoreManagement.Inventory.StockMovement", b =>
                {
                    b.HasOne("StoreManagement.Products.ProductVariant", "ProductVariant")
                        .WithMany()
            ...
            modelBuilder.Entity("StoreManagement.Orders.OrderItem", b =>
                {
                    b.HasOne("StoreManagement.Orders.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("StoreManagement.Products.Product", b =>
                {
                    b.HasOne("StoreManagement.Categories.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("StoreManagement.Products.ProductVariant", b =>
                {
                    b.HasOne("StoreManagement.Products.Product", "Product")
                        .WithMany("Variants")
