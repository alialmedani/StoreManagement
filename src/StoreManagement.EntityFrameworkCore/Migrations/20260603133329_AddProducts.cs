        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedColor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Size = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    NormalizedSize = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "UX_StoreManagement_Products_CategoryId_NormalizedName_Active",
                table: "AppProducts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreManagement_ProductVariants_ProductId",
                table: "AppProductVariants",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "UX_StoreManagement_ProductVariants_ProductId_Color_Size_Active",
                table: "AppProductVariants",
                columns: new[] { "ProductId", "NormalizedColor", "NormalizedSize" },
                unique: true,
                filter: "[IsDeleted] = 0");
        }
